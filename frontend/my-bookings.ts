...
function fetchBookings(): void {
    ...
    fetch("/sports_rental_system/api/get_my_bookings.php", {
        credentials: "include"
    })
        .then(res => res.json())
        .then(data => {
...
function checkRefundInfo(): void {
    ...
    fetch("/sports_rental_system/api/get_refund_info.php", {
        credentials: "include"
    })
        .then(res => res.json())
        .then(res => {
...
function saveRefundInfo(): void {
    ...
    fetch("/sports_rental_system/api/save_refund_info.php", {
        method: "POST",
...
function submitCancel(): void {
    ...
    fetch("/sports_rental_system/api/cancel_bookings.php", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
        body: JSON.stringify({
